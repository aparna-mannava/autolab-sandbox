...
output "us01vlbktst60" {
  value = {
    "fqdn"  = "${module.us01vlbktst60.fqdn}",
    "alias" = "${module.us01vlbktst60.alias}",
    "ip"    = "${module.us01vlbktst60.ip}",
  }
}
