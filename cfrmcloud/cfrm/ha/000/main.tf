...
output "chc-ic-00-be-lab01" {
  value = {
    "fqdn"  = module.chc-ic-00-be-lab01.fqdn,
    "alias" = module.chc-ic-00-be-lab01.alias,
    "ip"    = module.chc-ic-00-be-lab01.ip,
  }
}

output "chc-ic-00-be-lab02" {
  value = {
    "fqdn"  = module.chc-ic-00-be-lab02.fqdn,
    "alias" = module.chc-ic-00-be-lab02.alias,
    "ip"    = module.chc-ic-00-be-lab02.ip,
  }
}
output "chc-ic-00-fe-lab01" {
  value = {
    "fqdn"  = module.chc-ic-00-fe-lab01.fqdn,
    "alias" = module.chc-ic-00-fe-lab01.alias,
    "ip"    = module.chc-ic-00-fe-lab01.ip,
  }
}

output "chc-ic-00-fe-lab02" {
  value = {
    "fqdn"  = module.chc-ic-00-fe-lab02.fqdn,
    "alias" = module.chc-ic-00-fe-lab02.alias,
    "ip"    = module.chc-ic-00-fe-lab02.ip,
  }
}

output "chc-ic-00-fe-lab03" {
  value = {
    "fqdn"  = module.chc-ic-00-fe-lab03.fqdn,
    "alias" = module.chc-ic-00-fe-lab03.alias,
    "ip"    = module.chc-ic-00-fe-lab03.ip,
  }
}