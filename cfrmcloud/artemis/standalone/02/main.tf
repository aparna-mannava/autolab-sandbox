...
module "artemisdev_ny2_1" {
  ...
  hostname             = "${local.facts.hostname}art${local.facts.bt_env}" // us01vlcfrmart02
  alias                = "${local.facts.bt_product}-${local.datacenter.id}-${local.facts.bt_tier}-${local.facts.bt_role}-${local.facts.bt_env}"//   cfrmcloud-ny2-dev-artemis-02.autolab.saas-n.com
