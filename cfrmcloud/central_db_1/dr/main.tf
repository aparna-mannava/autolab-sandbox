...
module "db_lab_1" {
  ...
  hostname             = "${local.facts.hostname}dr01" //   us01vlcfdbdr01.auto.saas-n.com
  alias                = "${local.facts.bt_product}-${local.facts.bt_tier}-${local.datacenter.id}-oradb01"//cfrmcloud-dr-ny2-oradb01
