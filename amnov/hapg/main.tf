...
locals {
  ...
  hapg_servers    = ["us01vlhapg81","us01vlhapg82","us01vlhapg83"]
  ...
  hapgfacts       = {
    ...
    "bt_cluster_name"         = "us01vltstnov16"
    "bt_pg_version"           = "16"
  }
  haproxyfacts    = {
    "bt_env"                  = local.bt_env
...
output "us01vlhapg81" {
  value = {
    "fqdn"  = "${module.us01vlhapg81.fqdn}",
    "alias" = "${module.us01vlhapg81.alias}",
    "ip"    = "${module.us01vlhapg81.ip}",
  }
}

output "us01vlhapg82" {
  value = {
    "fqdn"  = "${module.us01vlhapg82.fqdn}",
    "alias" = "${module.us01vlhapg82.alias}",
    "ip"    = "${module.us01vlhapg82.ip}",
  }
}

output "us01vlhapg83" {
  value = {
    "fqdn"  = "${module.us01vlhapg83.fqdn}",
    "alias" = "${module.us01vlhapg83.alias}",
    "ip"    = "${module.us01vlhapg83.ip}",
  }
}

output "us01vlpxy80" {
  value = {
    "fqdn"  = "${module.us01vlpxy80.fqdn}",
    "alias" = "${module.us01vlpxy80.alias}",
    "ip"    = "${module.us01vlpxy80.ip}",
  }
}