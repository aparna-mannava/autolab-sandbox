...
locals {
  ...
  facts = {
    ...
    "bt_cluster_name" = "pgcs2"
    "bt_pg_version" = "13"
  }
}

module "ny2_pgcs2_patroni_1" {
...
output "ny2_pgcs2_patroni_1" {
  value = {
    "fqdn" = "${module.ny2_pgcs2_patroni_1.fqdn}",
    "alias" = "${module.ny2_pgcs2_patroni_1.alias}",
    "ip" = "${module.ny2_pgcs2_patroni_1.ip}",
  }
}
