...
module "crowdstriketestwin" {
  source              = "git::https://us-pr-stash.saas-p.com/scm/trrfrm/terraform-module-infrastructure.git?ref=master"
  hostname            = "us01vwcsts2"
  alias               = "ny2-cloud-crowdstriketest2"
  bt_infra_cluster    = "ny5-azc-ntnx-16"
  bt_infra_network    = "ny2-autolab-app-ahv"
  cpus                = 2
  lob                 = "CLOUD"
...
output "crowdstriketestwin" {
  value = {
    "fqdn"  = module.crowdstriketestwin.fqdn,
    "alias" = module.crowdstriketestwin.alias,
    "ip"    = module.crowdstriketestwin.ip
  }
}
