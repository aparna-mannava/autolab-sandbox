...
output "us01vlbktst40" {
  value = {
    "fqdn"  = "${module.us01vlbktst40.fqdn}",
    "alias" = "${module.us01vlbktst40.alias}",
    "ip"    = "${module.us01vlbktst40.ip}",
  }
}
