...
module "cloud_dbserver_1" {
  ...
  hostname             = "us01vldbhsp60"
  alias                = "${local.lob}-${local.facts.bt_tier}${local.facts.bt_env}-${local.facts.bt_customer}-db60"
