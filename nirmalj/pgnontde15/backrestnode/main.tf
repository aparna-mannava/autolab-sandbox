...
module "autolab_pg15nontde_backrest_1" {
...
output "autolab_pg15nontde_backrest_1" {
  value = {
    "fqdn"  = "${module.autolab_pg15nontde_backrest_1.fqdn}",
    "alias" = "${module.autolab_pg15nontde_backrest_1.alias}",
    "ip"    = "${module.autolab_pg15nontde_backrest_1.ip}",
  }
}
