...
module "autolab_pg14nontde_hapg_1" {
...
module "autolab_pg14nontde_hapg_2" {
  source               = "git::https://gitlab.saas-p.com/shared/terraform-modules/terraform-module-infrastructure.git?ref=master"
...
module "autolab_pg14nontde_hapx_1" {
  source               = "git::https://gitlab.saas-p.com/shared/terraform-modules/terraform-module-infrastructure.git?ref=master"
...
output "autolab_pg14nontde_hapg_1" {
  value = {
    "fqdn"  = "${module.autolab_pg14nontde_hapg_1.fqdn}",
    "alias" = "${module.autolab_pg14nontde_hapg_1.alias}",
    "ip"    = "${module.autolab_pg14nontde_hapg_1.ip}",
  }
}

output "autolab_pg14nontde_hapg_2" {
  value = {
    "fqdn"  = "${module.autolab_pg14nontde_hapg_2.fqdn}",
    "alias" = "${module.autolab_pg14nontde_hapg_2.alias}",
    "ip"    = "${module.autolab_pg14nontde_hapg_2.ip}",
  }
}

output "autolab_pg14nontde_hapx_1" {
  value = {
    "fqdn"  = "${module.autolab_pg14nontde_hapx_1.fqdn}",
    "alias" = "${module.autolab_pg14nontde_hapx_1.alias}",
    "ip"    = "${module.autolab_pg14nontde_hapx_1.ip}",
  }
}
