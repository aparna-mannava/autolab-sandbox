...
locals {
  ...
  hapg_servers    = ["us01vlhapgts102","us01vlhapgts102","us01vlhapgts103"]
...
output "us01vlbkts101" {
  value = {
    "fqdn"  = "${module.us01vlbkts101.fqdn}",
    "alias" = "${module.us01vlbkts101.alias}",
    "ip"    = "${module.us01vlbkts101.ip}",
  }
}