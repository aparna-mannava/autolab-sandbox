...
output "us01vlhapgts70" {
  value = {
    "fqdn"  = "${module.us01vlhapgts70.fqdn}",
    "alias" = "${module.us01vlhapgts70.alias}",
    "ip"    = "${module.us01vlhapgts70.ip}",
  }
}

output "us01vlhapgts71" {
  value = {
    "fqdn"  = "${module.us01vlhapgts71.fqdn}",
    "alias" = "${module.us01vlhapgts71.alias}",
    "ip"    = "${module.us01vlhapgts71.ip}",
  }
}
output "us01vlprxyts70" {
  value = {
    "fqdn"  = "${module.us01vlprxyts70.fqdn}",
    "alias" = "${module.us01vlprxyts70.alias}",
    "ip"    = "${module.us01vlprxyts70.ip}",
  }
}
