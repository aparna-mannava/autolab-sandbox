...
locals {
  etcd_servers    = ["us01vletcd101"]
  hapg_servers    = ["us01vlpgdb80","us01vlpgdb90","us01vlpgdb100"]
  haproxy_server  = ["us01vlpx101"]
  backrest_server = ["us01vlbk101"]
...
output "us01vlbk101" {
  value = {
    "fqdn"  = "module.us01vlbk101.fqdn",
    "alias" = "module.us01vlbk101.alias",
    "ip"    = "module.us01vlbk101.ip",
  }
}