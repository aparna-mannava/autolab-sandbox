...
output "ny2_postpat_backrest_1" {
  value = {
    "fqdn"  = "module.ny2_postpat_backrest_1.fqdn",
    "alias" = "module.ny2_postpat_backrest_1.alias",
    "ip"    = "module.ny2_postpat_backrest_1.ip",
  }
}
