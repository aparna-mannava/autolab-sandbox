...
output "pgclstrdmdr_backrest_1" {
  value = {
    "fqdn"  = "module.pgclstrdmdr_backrest_1.fqdn",
    "alias" = "module.pgclstrdmdr_backrest_1.alias",
    "ip"    = "module.pgclstrdmdr_backrest_1.ip",
  }
}
