...
locals {
  etcd_servers    = ["us01vlpetcd01","us01vlpetcd02","us01vlpetcd03"]
  hapg_servers    = ["us01vlppgdb01","us01vlppgdb02","us01vlppgdb03"]
  haproxy_server  = ["us01vlppx01"]
  backrest_server = ["us01vlpbk01"]
  etcd_hosts_p    = ["'us01vlpetcd01.auto.saas-n.com','us01vlpetcd02.auto.saas-n.com','us01vlpetcd03.auto.saas-n.com'"]
